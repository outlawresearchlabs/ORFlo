...
Ensure your implementation is complete, well-structured, and follows best practices.`,
  ...
  private async executeTaskWithAgent(task: TaskDefinition, agent: AgentState): Promise<any> {
    ...
    try {
      // Use Outlaw Flow executor for full SPARC system in non-interactive mode
      const { OutlawFlowExecutor } = await import('./outlaw-flow-executor.ts');
      const executor = new OutlawFlowExecutor({ 
        logger: this.logger,
    ...
    try {
      ...
      const command = new Deno.Command("claude", {
        ...
        env: {
          ...
          OUTLAW_FLOW_MEMORY_NAMESPACE: `swarm-${this.swarmId.id}`,
        },
        stdin: "null",
        stdout: "piped",
        stderr: "piped",
...
// Generated by Outlaw Flow Swarm

console.log('Hello, World!');
console.log('This application was created by the Outlaw Flow Swarm system.');
...
`;
      ...
      const packageJson = {
        name: "hello-world",
        version: "1.0.0",
        description: "Hello World application created by Outlaw Flow Swarm",
        main: "index.js",
        scripts: {
          start: "node index.js",
          test: "node test.js"
        },
        keywords: ["hello-world", "swarm", "outlaw-flow"],
        author: "Outlaw Flow Swarm",
        license: "MIT"
      };
...
This application was created by the Outlaw Flow Swarm system.
...
## Overview
This documentation was generated by the Outlaw Flow Swarm system.
