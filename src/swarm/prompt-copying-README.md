...
A comprehensive, enterprise-grade prompt copying mechanism designed for Outlaw-Flow projects. This system provides efficient, reliable, and safe copying of prompt files with advanced features like parallel processing, conflict resolution, verification, and rollback capabilities.
...
### Installation
```bash
npm install -g @outlaw-flow/prompt-copier
```
