...
- **Outlaw Flow integration** for orchestration
...
The template is automatically installed when initializing a new Outlaw Flow project. To manually install:
...
### Commands
- Main commands for Outlaw Flow integration
...
- Use `/outlaw-flow-*` for Outlaw Flow features
...
- Refer to Outlaw Flow documentation