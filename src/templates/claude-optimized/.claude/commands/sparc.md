...
npx outlaw-flow sparc batch-run --modes '{
...
npx outlaw-flow sparc pipeline --stages '[
...
npx outlaw-flow sparc batch-tdd --features '{
...
npx outlaw-flow sparc batch-analyze --components '{
...
npx outlaw-flow sparc batch-spec --components '[
...
npx outlaw-flow sparc batch-pseudocode --algorithms '{
...
npx outlaw-flow sparc distributed-architect --services '[
...
npx outlaw-flow sparc parallel-tdd --config '{
  "modules": {
...
npx outlaw-flow sparc batch-integrate --components '[
...
npx outlaw-flow sparc batch-memory-store --data '{
...
npx outlaw-flow sparc batch-memory-query --queries '[
...
npx outlaw-flow sparc swarm-batch --project "enterprise-app" --config '{
  "phases": [
    {
      "name": "design",
...
npx outlaw-flow sparc distribute --analysis '{
...
npx outlaw-flow sparc cache-config --settings '{
...
npx outlaw-flow sparc enterprise-flow --project "fintech-platform" --parallel-config '{
  "specification": {
...
npx outlaw-flow sparc migrate-batch --from "monolith" --to "microservices" --strategy '{
...
npx outlaw-flow sparc ml-pipeline --config '{
  "data-pipeline": {
...
npx outlaw-flow sparc monitor-batch --dashboards '[
...
npx outlaw-flow sparc analyze-performance --metrics '{
