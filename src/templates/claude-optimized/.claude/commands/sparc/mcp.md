...
npx outlaw-flow test:integration:auth & \
npx outlaw-flow test:integration:data & \
npx outlaw-flow test:integration:storage & \
wait
```
...
1. Run directly: `npx outlaw-flow sparc run mcp-optimized "your task"`
...
npx outlaw-flow sparc run mcp-optimized "integrate auth, payment, and notification services"

# Batch API configuration
npx outlaw-flow sparc run mcp-optimized "configure all external service endpoints"
```
