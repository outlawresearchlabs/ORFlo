...
1. Run directly: `npx outlaw-flow sparc run refinement-optimization-mode-optimized "your task"`
...
npx outlaw-flow sparc run refinement-optimization-mode-optimized "optimize all modules"

# Batch refactor large files
npx outlaw-flow sparc run refinement-optimization-mode-optimized "break down all files over 500 lines"
```