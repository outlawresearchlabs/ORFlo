...
- **Outlaw Flow Configuration**: Default SPARC modes, swarm strategies, coordination modes
- **Persistent Storage**: Settings saved to localStorage with import/export capabilities

### Outlaw Flow Integration
- **Built-in Commands**: Support for all major Outlaw Flow commands
...
1. Start Claude Code with HTTP transport enabled:
   ```bash
   outlaw-flow start --transport http --port 3000
   ```
