...
describe('Outlaw-Flow CLI', () => {
  ...
  describe('Help output', () => {
    test('should show help when no arguments provided', async () => {
      ...
      expect(output).toContain('Outlaw-Flow v2.0.0');
      expect(output).toContain('USAGE:');
      expect(output).toContain('outlaw-flow <command> [options]');
    });

    test('should show help for --help flag', async () => {
      process.argv = ['node', 'outlaw-flow', '--help'];
    ...
    test('should show version for --version flag', async () => {
      process.argv = ['node', 'outlaw-flow', '--version'];
  ...
  describe('Command execution', () => {
    test('should execute valid command', async () => {
      process.argv = ['node', 'outlaw-flow', 'init', '--sparc'];
    ...
    test('should handle command with multiple arguments', async () => {
      process.argv = ['node', 'outlaw-flow', 'swarm', 'Build a REST API', '--strategy', 'development'];
    ...
    test('should show error for unknown command', async () => {
      process.argv = ['node', 'outlaw-flow', 'invalid-command'];
  ...
  describe('Error handling', () => {
    test('should handle command execution errors gracefully', async () => {
      process.argv = ['node', 'outlaw-flow', 'init'];
    ...
    test('should handle missing required arguments', async () => {
      process.argv = ['node', 'outlaw-flow', 'agent'];
