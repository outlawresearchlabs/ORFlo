...
1. **Requirements Gathering** (15 mins)
   ...
   - Store requirements: \`npx outlaw-flow memory store ${memoryNamespace}_requirements "..."\`
...
2. **Specification Writing** (20 mins)
   ...
   - Store specs: \`npx outlaw-flow memory store ${memoryNamespace}_specifications "..."\`
...
3. **Pseudocode Development** (20 mins)
   ...
   - Map process flows
   - Include TDD anchors
   - Store pseudocode: \`npx outlaw-flow memory store ${memoryNamespace}_pseudocode "..."\`
