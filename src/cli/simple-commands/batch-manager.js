...
async function createInteractiveConfig(outputFile) {
  ...
  try {
    ...
    console.log(`4. Run: outlaw-flow init --config ${outputFile}`);
  } catch (error) {
...
function showBatchManagerHelp() {
  ...
  console.log('USAGE:');
  console.log('  outlaw-flow batch <command> [options]\n');
  ...
  console.log('  outlaw-flow batch create-config my-batch.json');
  console.log('  outlaw-flow batch create-config --interactive');
  console.log('  outlaw-flow batch validate-config my-batch.json');
  console.log('  outlaw-flow batch estimate my-batch.json');
  console.log('  outlaw-flow batch list-templates');
  console.log('  outlaw-flow batch list-environments\n');
  
  console.log('INTEGRATION:');
  console.log('  Use created configs with: outlaw-flow init --config <file>');
  console.log('  Or batch init directly: outlaw-flow init --batch-init project1,project2');
}