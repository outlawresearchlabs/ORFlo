...
export class PostInitValidator {
  ...
  async checkFileIntegrity() {
    ...
    const expectedFiles = [
      ...
      { path: 'memory/outlaw-flow-data.json', minSize: 10 },
      { path: 'memory/agents/README.md', minSize: 10 },
      { path: 'memory/sessions/README.md', minSize: 10 },
      { path: 'outlaw-flow', minSize: 50, executable: true }
    ];
  ...
  async checkPermissions() {
    ...
    const itemsToCheck = [
      ...
      { path: 'outlaw-flow', type: 'file', requiredMode: 0o755 },
  ...
  async validateMemoryStructure() {
    ...
    const expectedFiles = ['outlaw-flow-data.json', 'agents/README.md', 'sessions/README.md'];
