...
async function listTasks(subArgs, flags) {
  ...
  if (verbose) {
    console.log('\nTo create tasks:');
    console.log('  outlaw-flow task create research "Market analysis"');
    console.log('  outlaw-flow task create code "Implement API"');
    console.log('  outlaw-flow task create analysis "Data processing"');
  }
}
...
function showTaskHelp() {
  ...
  console.log('  outlaw-flow task create research "Market analysis" --priority 8');
  console.log('  outlaw-flow task list --filter running');
  console.log('  outlaw-flow task workflow examples/development-workflow.json');
  console.log('  outlaw-flow task coordination status');
}