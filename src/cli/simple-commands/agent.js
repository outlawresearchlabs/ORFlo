...
async function listAgents(subArgs, flags) {
  ...
  console.log('\nTo create agents:');
  console.log('  outlaw-flow agent spawn researcher --name "ResearchBot"');
  console.log('  outlaw-flow agent spawn coder --name "CodeBot"');
  console.log('  outlaw-flow agent spawn analyst --name "DataBot"');
}
...
async function manageHierarchy(subArgs, flags) {
  ...
  switch (hierarchyCmd) {
    ...
    default:
      ...
      console.log('  outlaw-flow agent hierarchy create enterprise');
      console.log('  outlaw-flow agent hierarchy show');
  }
}
...
function showAgentHelp() {
  ...
  console.log();
  console.log('Examples:');
  console.log('  outlaw-flow agent spawn researcher --name "DataBot"');
  console.log('  outlaw-flow agent list --verbose');
  console.log('  outlaw-flow agent hierarchy create enterprise');
  console.log('  outlaw-flow agent ecosystem status');
}