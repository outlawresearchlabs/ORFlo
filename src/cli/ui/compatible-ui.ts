...
export class CompatibleUI {
  ...
  private render(): void {
    ...
    // Header
    console.log(chalk.cyan.bold('🧠 Outlaw-Flow System Monitor'));
  ...
  private showHelp(): void {
    console.log();
    console.log(chalk.cyan.bold('🧠 Outlaw-Flow System Monitor - Help'));
    console.log(chalk.gray('─'.repeat(60)));
    console.log();
...
export async function launchUI(): Promise<void> {
  ...
  console.log(chalk.green('✅ Starting Outlaw-Flow UI (compatible mode)'));
