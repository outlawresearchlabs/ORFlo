...
async function analyzeResults() {
  try {
    ...
    console.log("📊 Outlaw-Flow Parallel Agent Test Results Analysis");
...
async function generateDetailedReport(results: FullResults) {
  const report = `# Outlaw-Flow Parallel Agent Test Report
...
---
*Report generated by Outlaw-Flow Parallel Test Suite*
`;
