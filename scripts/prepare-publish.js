...
const versionFiles = [
  ...
  { path: 'bin/outlaw-flow', pattern: /VERSION="[^"]+"/, replacement: `VERSION="${version}"` },
  ...
  { path: 'src/cli/simple-commands/process-ui-enhanced.js', pattern: /Outlaw-Flow Process Management UI v[0-9.]+/, replacement: `Outlaw-Flow Process Management UI v${version}` },
