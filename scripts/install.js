...
console.log('Installing Outlaw-Flow...');
...
async function main() {
  try {
    ...
    console.log('Outlaw-Flow installation completed!');
    console.log('You can now use: npx outlaw-flow or outlaw-flow (if installed globally)');
