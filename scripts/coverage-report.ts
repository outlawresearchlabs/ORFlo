...
<html>
<head>
    <title>Outlaw-Flow Coverage Report</title>
    <style>
...
<body>
    <div class="header">
        <h1>📊 Outlaw-Flow Coverage Report</h1>
    ...
    <div class="footer">
        <p>Outlaw-Flow Coverage Report - Advanced AI Agent Orchestration System</p>
    </div>
</body>
</html>`;
...
async function main(): Promise<void> {
  ...
  if (args.help) {
    console.log(`
📊 Outlaw-Flow Coverage Analysis Tool
