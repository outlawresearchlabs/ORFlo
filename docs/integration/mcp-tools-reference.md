# Outlaw Flow v2.0.0 - Complete MCP Tools Reference

## 🎯 Overview

This document provides comprehensive documentation for all 87 MCP tools available in Outlaw Flow v2.0.0, including ruv-swarm integration tools and native Outlaw Flow capabilities.
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 coordination swarm-status
```
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 coordination agent-list
```
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 performance report \
  --timeframe 24h \
  --format detailed
```
...
### mcp__outlaw-flow__bottleneck_analyze
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 bottleneck analyze \
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 workflow create \
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 github repo-analyze \
...
### mcp__outlaw-flow__daa_agent_create
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 daa agent-create \
...
**Example Usage:**
```bash
npx outlaw-flow@2.0.0 health-check \
...
# Execute workflow
npx outlaw-flow@2.0.0 workflow execute \
  --workflow-id "workflow_20250706_141350"
```

This comprehensive MCP tools reference provides detailed documentation for all 87 tools available in Outlaw Flow v2.0.0, enabling developers to leverage the full power of intelligent coordination and neural-enhanced development workflows.