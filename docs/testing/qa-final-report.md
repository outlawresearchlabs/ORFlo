# 📊 Outlaw Flow v2.0.0 - Final QA Report & Sign-off
...
**Outlaw Flow v2.0.0 NPX version is PRODUCTION READY** and recommended for immediate enterprise deployment.
...
OUTLAW_FLOW_CONFIG # Optional configuration path
```
...
**SPARC Workaround**:
```bash
# Instead of: npx outlaw-flow@2.0.0 sparc modes (fails)
# Use individual modes:
npx outlaw-flow@2.0.0 sparc architect "design system"
npx outlaw-flow@2.0.0 sparc code "implement feature"
npx outlaw-flow@2.0.0 sparc tdd "test workflow"
```
...
npx outlaw-flow@2.0.0 swarm "production objective" \
...
npx outlaw-flow@2.0.0 github pr-manager "enterprise code review"
```
...
**✅ RECOMMENDED**:
- NPX execution: `npx outlaw-flow@2.0.0`
...
**Scope of Approval**:
- ✅ NPX version (`npx outlaw-flow@2.0.0`) for all production use
